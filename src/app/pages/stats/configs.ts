export let configs = {
  17: {
    ...
    fieldsConfig: {
      ...
      arrow_correct_count: 'number',
      arrow_min_angle: 'number',
      arrow_max_angle: 'number',
      arrow_average_angle: 'number',
      arrow_target_min_height: 'number',
      arrow_target_max_height: 'number',
      arrow_target_average_height: 'number',
      arrow_incorrect_count: 'number',
    },
  },
  8: {
    moduleName: 'GardenDo',
